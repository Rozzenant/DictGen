"""
Django settings for dictgen project.
...
# Отключаем автоперезагрузку для экономии ресурсов
USE_RELOADER = False
...
WSGI_APPLICATION = 'dictgen.wsgi.application'
...
# Используем кастомную конфигурацию логирования из logger.py
